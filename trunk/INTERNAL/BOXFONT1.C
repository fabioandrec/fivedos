...
CLIPPER BoxFont()
{
   ...
   * ( BorderRight +  1 ) = 0x03;  // 00000011
   * ( BorderRight +  2 ) = 0x03;  // 00000011
   * ( BorderRight +  3 ) = 0x03;  // 00000011
   * ( BorderRight +  4 ) = 0x03;  // 00000011
   * ( BorderRight +  5 ) = 0x03;  // 00000011
   * ( BorderRight +  6 ) = 0x03;  // 00000011
   * ( BorderRight +  7 ) = 0x03;  // 00000011
   * ( BorderRight +  8 ) = 0x03;  // 00000011
   * ( BorderRight +  9 ) = 0x03;  // 00000011
   * ( BorderRight + 10 ) = 0x03;  // 00000011
   * ( BorderRight + 11 ) = 0x03;  // 00000011
   * ( BorderRight + 12 ) = 0x03;  // 00000011
   * ( BorderRight + 13 ) = 0x03;  // 00000011
   * ( BorderRight + 14 ) = 0x03;  // 00000011
   * ( BorderRight + 15 ) = 0x03;  // 00000011
   * ( BorderRight + 16 ) = 0x03;  // 00000011
   ...
   * ( _16MaximizeLeft +  3 ) = 0xFF;  // 11111111 11111100
   * ( _16MaximizeLeft +  4 ) = 0x80;  // 10000000 00000100
   * ( _16MaximizeLeft +  5 ) = 0x80;  // 10000000 00000100
   * ( _16MaximizeLeft +  6 ) = 0x80;  // 10000000 00000100
   * ( _16MaximizeLeft +  7 ) = 0x80;  // 10000000 00000100
   * ( _16MaximizeLeft +  8 ) = 0x83;  // 10000011 00000100
   * ( _16MaximizeLeft +  9 ) = 0x87;  // 10000111 10000100
   * ( _16MaximizeLeft + 10 ) = 0x8F;  // 10001111 11000100
   * ( _16MaximizeLeft + 11 ) = 0x9F;  // 10011111 11100100
   * ( _16MaximizeLeft + 12 ) = 0x80;  // 10000000 00000100
   * ( _16MaximizeLeft + 13 ) = 0x80;  // 10000000 00000100
   * ( _16MaximizeLeft + 14 ) = 0x80;  // 10000000 00000100
   * ( _16MaximizeLeft + 15 ) = 0xFF;  // 11111111 11111100
   ...
   * ( _16MaximizeRight +  3 ) = 0xFC;  // 11111111 11111100
   * ( _16MaximizeRight +  4 ) = 0x04;  // 10000000 00000100
   * ( _16MaximizeRight +  5 ) = 0x04;  // 10000000 00000100
   * ( _16MaximizeRight +  6 ) = 0x04;  // 10000000 00000100
   * ( _16MaximizeRight +  7 ) = 0x04;  // 10000000 00000100
   * ( _16MaximizeRight +  8 ) = 0x04;  // 10000011 00000100
   * ( _16MaximizeRight +  9 ) = 0x84;  // 10000111 10000100
   * ( _16MaximizeRight + 10 ) = 0xC4;  // 10001111 11000100
   * ( _16MaximizeRight + 11 ) = 0xE4;  // 10011111 11100100
   * ( _16MaximizeRight + 12 ) = 0x04;  // 10000000 00000100
   * ( _16MaximizeRight + 13 ) = 0x04;  // 10000000 00000100
   * ( _16MaximizeRight + 14 ) = 0x04;  // 10000000 00000100
   * ( _16MaximizeRight + 15 ) = 0xFC;  // 11111111 11111100
   ...
   * ( _16MinimizeLeft +  3 ) = 0xFF;  // 11111111 11111100
   * ( _16MinimizeLeft +  4 ) = 0x80;  // 10000000 00000100
   * ( _16MinimizeLeft +  5 ) = 0x80;  // 10000000 00000100
   * ( _16MinimizeLeft +  6 ) = 0x80;  // 10000000 00000100
   * ( _16MinimizeLeft +  7 ) = 0x80;  // 10000000 00000100
   * ( _16MinimizeLeft +  8 ) = 0x9F;  // 10011111 11100100
   * ( _16MinimizeLeft +  9 ) = 0x8F;  // 10001111 11000100
   * ( _16MinimizeLeft + 10 ) = 0x87;  // 10000111 10000100
   * ( _16MinimizeLeft + 11 ) = 0x83;  // 10000011 00000100
   * ( _16MinimizeLeft + 12 ) = 0x80;  // 10000000 00000100
   * ( _16MinimizeLeft + 13 ) = 0x80;  // 10000000 00000100
   * ( _16MinimizeLeft + 14 ) = 0x80;  // 10000000 00000100
   * ( _16MinimizeLeft + 15 ) = 0xFF;  // 11111111 11111100
   ...
   * ( _16MinimizeRight +  3 ) = 0xFC;  // 11111111 11111100
   * ( _16MinimizeRight +  4 ) = 0x04;  // 10000000 00000100
   * ( _16MinimizeRight +  5 ) = 0x04;  // 10000000 00000100
   * ( _16MinimizeRight +  6 ) = 0x04;  // 10000000 00000100
   * ( _16MinimizeRight +  7 ) = 0x04;  // 10000000 00000100
   * ( _16MinimizeRight +  8 ) = 0xE4;  // 10011111 11100100
   * ( _16MinimizeRight +  9 ) = 0xC4;  // 10001111 11000100
   * ( _16MinimizeRight + 10 ) = 0x84;  // 10000111 10000100
   * ( _16MinimizeRight + 11 ) = 0x04;  // 10000011 00000100
   * ( _16MinimizeRight + 12 ) = 0x04;  // 10000000 00000100
   * ( _16MinimizeRight + 13 ) = 0x04;  // 10000000 00000100
   * ( _16MinimizeRight + 14 ) = 0x04;  // 10000000 00000100
   * ( _16MinimizeRight + 15 ) = 0xFC;  // 11111111 11111100
   ...
   * ( _16RestoreLeft +  3 )   = 0xFF;  // 11111111 11111100
   * ( _16RestoreLeft +  4 )   = 0x80;  // 10000000 00000100
   * ( _16RestoreLeft +  5 )   = 0x83;  // 10000011 00000100
   * ( _16RestoreLeft +  6 )   = 0x87;  // 10000111 10000100
   * ( _16RestoreLeft +  7 )   = 0x8F;  // 10001111 11000100
   * ( _16RestoreLeft +  8 )   = 0x9F;  // 10011111 11100100
   * ( _16RestoreLeft +  9 )   = 0x80;  // 10000000 00000100
   * ( _16RestoreLeft + 10 )   = 0x9F;  // 10011111 11100100
   * ( _16RestoreLeft + 11 )   = 0x8F;  // 10001111 11000100
   * ( _16RestoreLeft + 12 )   = 0x87;  // 10000111 10000100
   * ( _16RestoreLeft + 13 )   = 0x83;  // 10000011 00000100
   * ( _16RestoreLeft + 14 )   = 0x80;  // 10000000 00000100
   * ( _16RestoreLeft + 15 )   = 0xFF;  // 11111111 11111100
   ...
   * ( _16RestoreRight +  3 )  = 0xFC;  // 11111111 11111100
   * ( _16RestoreRight +  4 )  = 0x04;  // 10000000 00000100
   * ( _16RestoreRight +  5 )  = 0x04;  // 10000011 00000100
   * ( _16RestoreRight +  6 )  = 0x84;  // 10000111 10000100
   * ( _16RestoreRight +  7 )  = 0xC4;  // 10001111 11000100
   * ( _16RestoreRight +  8 )  = 0xE4;  // 10011111 11100100
   * ( _16RestoreRight +  9 )  = 0x04;  // 10000000 00000100
   * ( _16RestoreRight + 10 )  = 0xE4;  // 10011111 11100100
   * ( _16RestoreRight + 11 )  = 0xC4;  // 10001111 11000100
   * ( _16RestoreRight + 12 )  = 0x84;  // 10000111 10000100
   * ( _16RestoreRight + 13 )  = 0x04;  // 10000011 00000100
   * ( _16RestoreRight + 14 )  = 0x04;  // 10000000 00000100
   * ( _16RestoreRight + 15 )  = 0xFC;  // 11111111 11111100
   ...
   * ( _16CornerDRight +  1 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  2 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  3 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  4 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  5 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  6 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  7 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  8 )  = 0x03;  // 00000011
   * ( _16CornerDRight +  9 )  = 0x03;  // 00000011
   * ( _16CornerDRight + 10 )  = 0x03;  // 00000011
   * ( _16CornerDRight + 11 )  = 0x03;  // 00000011
   * ( _16CornerDRight + 12 )  = 0x03;  // 00000011
   * ( _16CornerDRight + 13 )  = 0x03;  // 00000011
   * ( _16CornerDRight + 14 )  = 0x03;  // 00000011
   * ( _16CornerDRight + 15 )  = 0x03;  // 00000011
   ...
   * ( _16ThumbRight +  2 ) = 0xFF;  // 01111111 11111111
   * ( _16ThumbRight +  3 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight +  4 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight +  5 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight +  6 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight +  7 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight +  8 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight +  9 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight + 10 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight + 11 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight + 12 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight + 13 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight + 14 ) = 0x03;  // 01000000 00000011
   * ( _16ThumbRight + 15 ) = 0xFF;  // 01111111 11111111
   ...
   * ( _16BorderUpRight +  2 ) = 0x03;  // 00000011
   * ( _16BorderUpRight +  3 ) = 0x03;  // 00000011
   * ( _16BorderUpRight +  4 ) = 0x03;  // 00000011
   * ( _16BorderUpRight +  5 ) = 0x03;  // 00000011
   * ( _16BorderUpRight +  6 ) = 0x03;  // 00000011
   * ( _16BorderUpRight +  7 ) = 0x03;  // 00000011
   * ( _16BorderUpRight +  8 ) = 0x03;  // 00000011
   * ( _16BorderUpRight +  9 ) = 0x03;  // 00000011
   * ( _16BorderUpRight + 10 ) = 0x03;  // 00000011
   * ( _16BorderUpRight + 11 ) = 0x03;  // 00000011
   * ( _16BorderUpRight + 12 ) = 0x03;  // 00000011
   * ( _16BorderUpRight + 13 ) = 0x03;  // 00000011
   * ( _16BorderUpRight + 14 ) = 0x03;  // 00000011
   * ( _16BorderUpRight + 15 ) = 0x03;  // 00000011
   * ( _16BorderUpRight + 16 ) = 0x03;  // 00000011
